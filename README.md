...
A complete simulation demonstrating how a spacecraft can autonomously:
1. estimate its relative state
2. plan a safe trajectory
3. execute precise control
4. achieve docking under uncertainty

## Summary (one-liner for CV)

Developed a Python-based simulation of autonomous spacecraft rendezvous and docking, integrating guidance, EKF-based navigation, and closed-loop control under realistic sensor noise and operational constraints.